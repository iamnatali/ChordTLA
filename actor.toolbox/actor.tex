...
\@x{ {\EXTENDS} TLC ,\, Integers ,\, Sequences ,\, ChannelsReliable}%
\@pvspace{8.0pt}%
...
\@x{ {\CONSTANTS} m ,\, bm}%
\@pvspace{8.0pt}%
\@x{ Clients \.{\defeq} \{ 0 ,\, 1 ,\, 3 \}}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{\@s{8.2} {\p@mmfair} {\p@algorithm} ActorStuff {\p@lbrace}}%
\@x{ {\p@variables} triggered \.{=} {\FALSE} {\p@semicolon}}%
...
\@x{\@s{47.76} Channels \.{=} InitChannels ( Clients ) {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} {\p@process} {\p@lparen} actor \.{\in} Clients {\p@rparen}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{Channels \.{:=} Send(Channels,\, 1,\, 0,\,
 {\langle}\@w{FindPredecessor},\, 6,\, 0{\rangle},\,
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{35.0}{0}{}%
\ensuremath{\mbox{``}FindPredcessor60\mbox{''},\,
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\mbox{``}Start\mbox{''})};
\end{cpar}%
\end{lcom}%
\@x{\@s{8.2} {\p@await} HasMessage ( Channels ,\, self ) {\p@semicolon}}%
 \@x{\@s{8.2} {\p@with} {\p@lparen} wrapped\_msg \.{\in} NextMessages (
 Channels ,\, self ) {\p@do}}%
 \@x{\@s{12.29} {\p@with} currentMessage \.{=} Payload ( wrapped\_msg )
 {\p@do}}%
\@x{\@s{16.4} kind \.{:=} Head ( currentMessage ) {\p@semicolon}}%
\@x{\@s{16.4} {\p@if} ( kind \.{=}\@w{FindPredecessor} ) \{}%
\@x{\@s{43.13} id \.{:=} currentMessage [ 2 ] {\p@semicolon}}%
\@x{\@s{43.13} asker \.{:=} currentMessage [ 3 ] {\p@semicolon}}%
 \@x{\@s{43.13} {\p@if} ( between01 ( self ,\, id ,\, fingerTables [ self ] [
 ( self \.{+} 1 ) \.{\%} bm ] ) ) \{}%
 \@x{\@s{43.13} Channels \.{:=} Send ( Channels ,\, self ,\, asker ,\,
 {\langle}\@w{Predecessor} ,\, self {\rangle} ,\,}%
\@x{\@s{67.73}\@w{Predecessor} ,\,}%
\@x{\@s{67.73}\@w{End} ) {\p@semicolon}}%
\@x{\@s{43.13} \} {\p@else} \{}%
\@x{\@s{47.23} i \.{:=} m {\p@semicolon}}%
\@x{\@s{47.23} FindFirstSuitableI\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{51.33} {\p@while} ( i \.{>} 0 \.{\land} {\lnot} ( ( self \.{+} ( 2 ^{
 ( i \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN} fingerTables [ self ] ) ) \{}%
\@x{\@s{55.43} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{51.33} \} {\p@semicolon}}%
\@x{\@s{47.23} MainLoop\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{51.33} {\p@while} ( i \.{>} 0 \.{\land} {\lnot} ( between00 ( self
 ,\, fingerTables [ self ] [ ( self \.{+} ( 2 ^{ ( i \.{-} 1 )} ) ) \.{\%} bm
 ] ,\, id ) ) ) \{}%
\@x{\@s{55.43} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{55.43} FindSuitableI\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{55.43} {\p@while} ( i \.{>} 0 \.{\land} {\lnot} ( ( self \.{+} ( 2 ^{
 ( i \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN} fingerTables [ self ] ) ) \{}%
\@x{\@s{59.53} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{55.43} \} {\p@semicolon}}%
\@x{\@s{51.33} \} {\p@semicolon}}%
\@x{\@s{47.23} {\p@if} ( i \.{=} 0 ) \{}%
 \@x{\@s{47.23} Channels \.{:=} Send ( Channels ,\, self ,\, fingerTables [
 self ] [ ( self \.{+} ( 2 ^{ ( m \.{-} 1 )} ) ) \.{\%} bm ] ,\,
 currentMessage ,\,}%
\@x{\@s{67.73}\@w{Transit} ,\,}%
\@x{\@s{67.73}\@w{Transit} ) {\p@semicolon}}%
\@x{\@s{51.33} \} {\p@else} \{}%
 \@x{\@s{51.33} Channels \.{:=} Send ( Channels ,\, self ,\, fingerTables [
 self ] [ ( self \.{+} ( 2 ^{ ( i \.{-} 1 )} ) ) \.{\%} bm ] ,\,
 currentMessage ,\,}%
\@x{\@s{67.73}\@w{Transit} ,\,}%
\@x{\@s{67.73}\@w{Transit} ) {\p@semicolon}}%
...
\@x{\@s{43.13} \}}%
\@x{\@s{34.93} \} {\p@else} \{}%
 \@x{\@s{39.93} {\p@if} ( kind \.{=}\@w{Predecessor} \.{\land} currentMessage
 [ 2 ] \.{=} 3 ) \{}%
\@x{\@s{44.03}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{44.03} triggered \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{39.93} \}}%
\@x{\@s{34.93} \} {\p@semicolon}}%
\@x{\@s{12.29} {\p@end} {\p@with} {\p@semicolon}}%
 \@x{\@s{8.2} Channels \.{:=} MarkMessageReceived ( Channels ,\, self ,\,
 wrapped\_msg ,\,\@w{Received} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 23:17:30 \ensuremath{YEKT} 2022 by \ensuremath{pervu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
