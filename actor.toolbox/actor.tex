...
\@x{}%
\@y{%
 \ensuremath{{\langle}\@w{FindPredecessor},\, id,\, asker{\rangle}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 procedure \ensuremath{trigger(trigger\_content\.{=}\@w{?}) \{
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{triggerLabel}:
}%
\@xx{}%
\@x{}%
\@y{\@s{12.5}%
 \ensuremath{triggered \.{:=} {\TRUE}};
}%
\@xx{}%
\@x{}%
\@y{\@s{12.5}%
...
\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\p@fair} {\p@process} ( actor \.{\in} \{ 0 ,\, 1 ,\, 3 \} )}%
 \@x{ {\p@variables} currentMessage \.{=} {\langle}\@w{?} ,\, \.{-} 1 ,\,
 \.{-} 1 {\rangle} {\p@semicolon}}%
\@x{\@s{8.2} kind \.{=}\@w{?} {\p@semicolon}}%
\@x{\@s{8.2}}%
\@y{%
 content \ensuremath{\.{=}} ``\ensuremath{no\_content}'';
}%
\@xx{}%
\@x{\@s{8.2} id \.{=} \.{-} 1 {\p@semicolon}}%
\@x{\@s{8.2} asker \.{=} \.{-} 1 {\p@semicolon}}%
...
\@y{\@s{7.5}%
 ...
 Append(actorInboxes[\mbox{``}actor\mbox{''}],\,
 {\langle}\mbox{``}trigger\mbox{''},\, \mbox{``}foo\mbox{''}{\rangle})};
}%
\@xx{}%
...
\@x{\@s{35.14}}%
\@y{%
 content \ensuremath{\.{:=} Head(Tail(currentMessage))};
}%
\@xx{}%
...
\@x{\@s{45.1} asker \.{:=} currentMessage [ 3 ] {\p@semicolon}}%
 ...
 self ] [ ( self \.{+} 1 ) \.{\%} bm ] ) {\p@rparen} {\p@lbrace}}%
...
\@x{\@s{49.19} FindFirstSuitableI\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{53.29} {\p@while} {\p@lparen} i \.{>} 0 \.{\land} {\lnot} ( ( self
 \.{+} ( 2 ^{ ( i \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN} fingerTables [
 self ] ) {\p@rparen} {\p@lbrace}}%
\@x{\@s{57.39} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{53.29} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{49.19} MainLoop\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{53.29} {\p@while} {\p@lparen} i \.{>} 0 \.{\land} {\lnot} ( between00
 ( self ,\, fingerTables [ self ] [ ( self \.{+} ( 2 ^{ ( i \.{-} 1 )} ) )
 \.{\%} bm ] ,\, id ) ) {\p@rparen} {\p@lbrace}}%
\@x{\@s{57.39} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{57.39} FindSuitableI\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{57.39} {\p@while} {\p@lparen} i \.{>} 0 \.{\land} {\lnot} ( ( self
 \.{+} ( 2 ^{ ( i \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN} fingerTables [
 self ] ) {\p@rparen} {\p@lbrace}}%
\@x{\@s{61.49} i \.{:=} i \.{-} 1 {\p@semicolon}}%
\@x{\@s{57.39} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{53.29} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{49.19} {\p@if} {\p@lparen} i \.{=} 0 {\p@rparen} {\p@lbrace}}%
 \@x{\@s{53.29} actorInboxes [ fingerTables [ self ] [ ( self \.{+} ( 2 ^{ ( m
 \.{-} 1 )} ) ) \.{\%} bm ] ] \.{:=}}%
 \@x{\@s{57.39} Append ( actorInboxes [ fingerTables [ self ] [ ( self \.{+} (
 2 ^{ ( m \.{-} 1 )} ) ) \.{\%} bm ] ] ,\, currentMessage ) {\p@semicolon}}%
\@x{\@s{53.29} {\p@rbrace} {\p@else} {\p@lbrace}}%
 \@x{\@s{53.29} actorInboxes [ fingerTables [ self ] [ ( self \.{+} ( 2 ^{ ( i
 \.{-} 1 )} ) ) \.{\%} bm ] ] \.{:=}}%
 \@x{\@s{61.49} Append ( actorInboxes [ fingerTables [ self ] [ ( self \.{+} (
 2 ^{ ( i \.{-} 1 )} ) ) \.{\%} bm ] ] ,\, currentMessage ) {\p@semicolon}}%
\@x{\@s{53.29} {\p@rbrace}}%
\@x{\@s{45.1} {\p@rbrace}}%
\@x{\@s{36.89} {\p@rbrace} {\p@else} {\p@lbrace}}%
 \@x{\@s{50.31} {\p@if} {\p@lparen} kind \.{=}\@w{Predecessor} \.{\land}
 currentMessage [ 2 ] \.{=} 3 {\p@rparen} {\p@lbrace}}%
\@x{\@s{54.41}}%
\@y{\@s{0}%
 call \ensuremath{trigger(content)};
}%
\@xx{}%
\@x{\@s{54.41} triggered \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{50.31} {\p@rbrace}}%
\@x{\@s{36.89} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{36.89} DefaultsBack\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{40.99} currentMessage \.{:=} {\langle}\@w{?} ,\, \.{-} 1 ,\, \.{-} 1
 {\rangle} {\p@semicolon}}%
\@x{\@s{40.99} kind \.{:=}\@w{?} {\p@semicolon}}%
\@x{\@s{40.99} id \.{:=} \.{-} 1 {\p@semicolon}}%
\@x{\@s{40.99} asker \.{:=} \.{-} 1 {\p@semicolon}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{afae019c}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{5415e04a}'')
}%
\@xx{}%
\@x{ {\CONSTANT} defaultInitValue}%
 \@x{ {\VARIABLES} actorInboxes ,\, triggered ,\, fingerTables ,\, pc ,\,
 currentMessage ,\, kind ,\, id ,\,}%
\@x{\@s{51.42} asker ,\, i}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} actorInboxes ,\, triggered ,\, fingerTables
 ,\, pc ,\, currentMessage ,\, kind ,\,}%
\@x{\@s{41.61} id ,\, asker ,\, i {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 ...
 \.{\,@@\,} ( 1 \.{\colongt}\@s{4.1} {\langle} {\rangle} ) \.{\,@@\,} ( 3
 \.{\colongt} {\langle} {\rangle} )}%
\@x{\@s{35.70} \.{\land} triggered \.{=} {\FALSE}}%
 \@x{\@s{35.70} \.{\land} fingerTables \.{=}\@s{65.6} ( 0 \.{\colongt} ( ( 1
 \.{\colongt} 1 ) \.{\,@@\,} ( 2 \.{\colongt} 3 ) \.{\,@@\,} ( 4 \.{\colongt}
 0 ) ) )}%
 \@x{\@s{107.84} \.{\,@@\,} ( 1 \.{\colongt} ( ( 2 \.{\colongt} 3 ) \.{\,@@\,}
 ( 3 \.{\colongt} 5 ) \.{\,@@\,} ( 5 \.{\colongt} 0 ) ) )}%
 \@x{\@s{107.84} \.{\,@@\,} ( 3 \.{\colongt} ( ( 4 \.{\colongt} 0 ) \.{\,@@\,}
 ( 5 \.{\colongt} 0 ) \.{\,@@\,} ( 7 \.{\colongt} 0 ) ) )}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process actor
...
\@x{\@s{166.43} \.{\land} {\UNCHANGED} triggered}%
 \@x{\@s{135.12} \.{\ELSE} \.{\land} {\IF} kind [ self ] \.{=}\@w{Predecessor}
 \.{\land} currentMessage [ self ] [ 2 ] \.{=} 3}%
\@x{\@s{189.70} \.{\THEN} \.{\land} triggered \.{'} \.{=} {\TRUE}}%
\@x{\@s{189.70} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{221.01} \.{\land} {\UNCHANGED} triggered}%
 \@x{\@s{166.43} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{DefaultsBack} ]}%
 \@x{\@s{166.43} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\, id ,\,
 asker ,\, i {\rangle}}%
 \@x{\@s{111.85} \.{\land} {\UNCHANGED} {\langle} fingerTables ,\,
 currentMessage ,\, kind {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ FindFirstSuitableI ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{FindFirstSuitableI}}%
 \@x{\@s{124.32} \.{\land} {\IF} i [ self ] \.{>} 0 \.{\land} {\lnot} ( ( self
 \.{+} ( 2 ^{ ( i [ self ] \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN}
 fingerTables [ self ] )}%
...
\@x{\@s{178.90} \.{\land} i \.{'} \.{=} i}%
 ...
 ,\,}%
\@x{\@s{197.91} fingerTables ,\, currentMessage ,\, kind ,\,}%
\@x{\@s{197.91} id ,\, asker {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{110.34} \.{\ELSE} \.{\land} {\IF} i [ self ] \.{=} 0}%
 ...
 self \.{+} ( 2 ^{ ( m \.{-} 1 )} ) ) \.{\%} bm ] ] ,\, currentMessage [ self
 ] ) ]}%
 \@x{\@s{164.92} \.{\ELSE} \.{\land} actorInboxes \.{'} \.{=} [ actorInboxes
 {\EXCEPT} {\bang} [ fingerTables [ self ] [ ( self \.{+} ( 2 ^{ ( i [ self ]
 \.{-} 1 )} ) ) \.{\%} bm ] ] \.{=} Append ( actorInboxes [ fingerTables [
 self ] [ ( self \.{+} ( 2 ^{ ( i [ self ] \.{-} 1 )} ) ) \.{\%} bm ] ] ,\,
 currentMessage [ self ] ) ]}%
 \@x{\@s{141.65} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self
 ]\@s{5.54} \.{=}\@w{DefaultsBack} ]}%
\@x{\@s{141.65} \.{\land} i \.{'} \.{=} i}%
 \@x{\@s{87.07} \.{\land} {\UNCHANGED} {\langle} triggered ,\, fingerTables
 ,\, currentMessage ,\,}%
\@x{\@s{160.66} kind ,\, id ,\, asker {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ FindSuitableI ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{FindSuitableI}}%
 \@x{\@s{103.10} \.{\land} {\IF} i [ self ] \.{>} 0 \.{\land} {\lnot} ( ( self
 \.{+} ( 2 ^{ ( i [ self ] \.{-} 1 )} ) ) \.{\%} bm \.{\in} {\DOMAIN}
 fingerTables [ self ] )}%
...
\@x{\@s{157.68} \.{\land} i \.{'} \.{=} i}%
 ...
 ,\, fingerTables ,\,}%
\@x{\@s{176.69} currentMessage ,\, kind ,\, id ,\, asker {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ DefaultsBack ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{DefaultsBack}}%
 \@x{\@s{101.18} \.{\land} currentMessage \.{'} \.{=} [ currentMessage
 {\EXCEPT} {\bang} [ self ] \.{=} {\langle}\@w{?} ,\, \.{-} 1 ,\, \.{-} 1
 {\rangle} ]}%
 \@x{\@s{101.18} \.{\land} kind \.{'} \.{=} [ kind {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{?} ]}%
 \@x{\@s{101.18} \.{\land} id \.{'} \.{=} [ id {\EXCEPT} {\bang} [ self ]
 \.{=} \.{-} 1 ]}%
 \@x{\@s{101.18} \.{\land} asker \.{'} \.{=} [ asker {\EXCEPT} {\bang} [ self
 ] \.{=} \.{-} 1 ]}%
 \@x{\@s{101.18} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{WaitForMessages} ]}%
 \@x{\@s{101.18} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\, triggered
 ,\, fingerTables ,\, i {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ actor ( self ) \.{\defeq} WaitForMessages ( self ) \.{\lor}
 ProcessMessage ( self )}%
 \@x{\@s{78.83} \.{\lor} FindFirstSuitableI ( self ) \.{\lor} MainLoop ( self
 )}%
 \@x{\@s{78.83} \.{\lor} FindSuitableI ( self ) \.{\lor} DefaultsBack ( self
 )}%
\@pvspace{8.0pt}%
...
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( Next )}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} \{ 0 ,\, 1 ,\, 3 \} \.{:} {\WF}_{
 vars} ( actor ( self ) ) \.{\land} {\SF}_{ vars} ( WaitForMessages ( self )
 )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Liveness \.{\defeq} {\Diamond} {\Box} Triggered}%
\@pvspace{8.0pt}%
 \@x{ LenStateConstraint \.{\defeq} Len ( actorInboxes [ 0 ] ) \.{\leq} 1
 \.{\land} Len ( actorInboxes [ 1 ] ) \.{\leq} 1 \.{\land} Len ( actorInboxes
 [ 3 ] ) \.{\leq} 1}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Feb} 20
 18:05:45 \ensuremath{YEKT} 2022 by \ensuremath{pervu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
