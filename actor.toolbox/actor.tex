...
\@x{\@s{8.2} {\p@mmfair} {\p@algorithm} ActorStuff {\p@lbrace}}%
 \@x{ {\p@variables} actorInboxes \.{=} (\@w{actor1} \.{\colongt}\@s{4.1}
 {\langle} {\rangle} ) \.{\,@@\,} (\@w{actor2} \.{\colongt}\@s{4.1}
 {\langle}\@w{OthersJoin} {\rangle} ) {\p@semicolon}}%
...
\@x{ {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{ {\p@fair} {\p@process} {\p@lparen} actor \.{\in} \{\@w{actor1}
 ,\,\@w{actor2} \} {\p@rparen}}%
...
\@x{\@s{32.8} ProcessMessage\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{36.89} {\p@if} {\p@lparen} kind \.{=}\@w{OthersJoin} {\p@rparen}
 {\p@lbrace}}%
\@x{\@s{45.1} {\p@call} trigger ( content ) {\p@semicolon}}%
\@x{\@s{36.89} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{e5b874e9}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{c9de62d2}'')
}%
\@xx{}%
 \@x{ {\VARIABLES} actorInboxes ,\, triggered ,\, pc ,\, stack ,\,
 trigger\_content ,\, currentMessage ,\,}%
\@x{\@s{51.42} kind ,\, content}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} actorInboxes ,\, triggered ,\, pc ,\, stack
 ,\, trigger\_content ,\,}%
\@x{\@s{41.61} currentMessage ,\, kind ,\, content {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( \{\@w{actor1} ,\,\@w{actor2} \} )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} actorInboxes \.{=} (\@w{actor1} \.{\colongt}\@s{4.1}
 {\langle} {\rangle} ) \.{\,@@\,} (\@w{actor2} \.{\colongt}\@s{4.1}
 {\langle}\@w{OthersJoin} ,\,\@w{actor1} {\rangle} )}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} currentMessage \.{=} [ self \.{\in} \{\@w{actor1}
 ,\,\@w{actor2} \} \.{\mapsto} {\langle}\@w{?} ,\,\@w{no\_content} {\rangle}
 ]}%
 \@x{\@s{35.70} \.{\land} kind \.{=} [ self \.{\in} \{\@w{actor1}
 ,\,\@w{actor2} \} \.{\mapsto}\@w{?} ]}%
 \@x{\@s{35.70} \.{\land} content \.{=} [ self \.{\in} \{\@w{actor1}
 ,\,\@w{actor2} \} \.{\mapsto}\@w{no\_content} ]}%
...
\@x{\@s{94.86} \.{\land} triggered \.{'} \.{=} {\TRUE}}%
 ...
 \.{=} Tail ( stack [ self ] ) ]}%
 \@x{\@s{94.86} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\,
 currentMessage ,\, kind ,\,}%
\@x{\@s{168.45} content {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{248.80} content {\rangle}}%
 ...
 \.{=}\@w{ProcessMessage} ]}%
 \@x{\@s{120.63} \.{\land} {\UNCHANGED} {\langle} triggered ,\, stack ,\,
 trigger\_content {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ProcessMessage ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{ProcessMessage}}%
\@x{\@s{111.85} \.{\land} {\IF} kind [ self ] \.{=}\@w{OthersJoin}}%
 \@x{\@s{135.12} \.{\THEN} \.{\land} \.{\land} stack \.{'} \.{=} [ stack
 {\EXCEPT} {\bang} [ self ] \.{=} {\langle} [ procedure
 \.{\mapsto}\@s{4.1}\@w{trigger} ,\,}%
\@x{\@s{341.74} pc\@s{31.36} \.{\mapsto}\@s{4.10}\@w{WaitForMessages} ,\,}%
 \@x{\@s{341.74} trigger\_content \.{\mapsto}\@s{4.1} trigger\_content [ self
 ] ] {\rangle}}%
\@x{\@s{339.18} \.{\circ} stack [ self ] ]}%
 \@x{\@s{177.54} \.{\land} trigger\_content \.{'} \.{=} [ trigger\_content
 {\EXCEPT} {\bang} [ self ] \.{=} content [ self ] ]}%
 \@x{\@s{166.43} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{triggerLabel} ]}%
 \@x{\@s{135.12} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{WaitForMessages} ]}%
 \@x{\@s{166.43} \.{\land} {\UNCHANGED} {\langle} stack ,\, trigger\_content
 {\rangle}}%
 \@x{\@s{111.85} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\, triggered
 ,\,}%
...
\@x{ Next \.{\defeq} ( \E\, self \.{\in} ProcSet \.{:} trigger ( self ) )}%
 \@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} \{\@w{actor1} ,\,\@w{actor2} \}
 \.{:} actor ( self ) )}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( Next )}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} \{\@w{actor1} ,\,\@w{actor2} \}
 \.{:} \.{\land} {\WF}_{ vars} ( actor ( self ) )}%
\@x{\@s{184.37} \.{\land} {\SF}_{ vars} ( WaitForMessages ( self ) )}%
\@x{\@s{184.37} \.{\land} {\WF}_{ vars} ( trigger ( self ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jan} 30
 19:33:19 \ensuremath{YEKT} 2022 by \ensuremath{pervu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
