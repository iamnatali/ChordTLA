...
\@x{\@s{8.2} WaitForMessagesBeforeJoin\@s{.5}\textrm{:+}\@s{3}}%
 ...
 {\p@lbrace}}%
\@x{\@s{35.24} WhileWaitForMessagesBeforeJoin\@s{.5}\textrm{:+}\@s{3}}%
\@pvspace{8.0pt}%
...
\@x{\@s{55.74} {\p@rbrace}}%
\@x{\@s{35.24} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{35.24} ReturnDefaultsBeforeJoin\@s{.5}\textrm{:+}\@s{3}}%
...
\@x{}%
\@y{\@s{2.5}%
 Stabilize\ensuremath{\.{:}\.{+}
}}%
\@xx{}%
\@x{}%
\@y{\@s{7.5}%
 if (joined)\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{actorInboxes[self] \.{:=} Append(actorInboxes[self],\,
...
\@x{}%
\@y{\@s{7.5}%
 \ensuremath{WhileWaitForMessages\.{:}\.{+}
}}%
\@xx{}%
\@x{}%
\@y{\@s{12.5}%
 while (\ensuremath{{\TRUE}}) \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{12.5}%
 if (\ensuremath{actorInboxes[self] \.{\neq} {\langle}{\rangle}})
 \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{currentMessage \.{:=} Head(actorInboxes[self])};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{kind \.{:=} Head(currentMessage)};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{actorInboxes[self] \.{:=} Tail(actorInboxes[self])};
}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
...
\@x{}%
\@y{\@s{20.0}%
 if (\ensuremath{kind \.{=} \@w{FindPredecessor}})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
 \ensuremath{id \.{:=} currentMessage[2]};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\,\backslash\,}}*await
 \ensuremath{fingerTables[self][fingerStart(self,\, 1,\, bm)] \.{\neq} NULL};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 if (\ensuremath{between01(self,\, id,\,
 fingerTables[self][fingerStart(self,\, 1,\, bm)])})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
 \ensuremath{actorInboxes[currentMessage[3]] \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
 \ensuremath{Append(actorInboxes[currentMessage[3]],\,
 {\langle}\@w{Predecessor},\, self,\, fingerTables[self][fingerStart(self,\,
 1,\, bm)]{\rangle})};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\}} else \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
...
\@x{}%
\@y{\@s{30.0}%
 \ensuremath{FindFirstSuitableI}:
}%
\@xx{}%
\@x{}%
\@y{\@s{30.0}%
 while (\ensuremath{i \.{>} 0 \.{\land} {\lnot}(fingerStart(self,\, i,\, bm)
 \.{\in} {\DOMAIN} fingerTables[self])})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{37.5}%
...
\@x{}%
\@y{\@s{30.0}%
 while (\ensuremath{i \.{>} 0 \.{\land} {\lnot}(between00(self,\,
 fingerTables[self][fingerStart(self,\, i,\, bm)],\, id))})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{40.0}%
...
\@x{}%
\@y{\@s{30.0}%
 if (\ensuremath{i \.{=} 0})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{40.0}%
 \ensuremath{actorInboxes[fingerTables[self][fingerStart(self,\, m,\, bm)]]
 \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{40.0}%
 \ensuremath{Append(actorInboxes[fingerTables[self][fingerStart(self,\, m,\,
 bm)]],\, currentMessage)};
}%
\@xx{}%
\@x{}%
...
\@x{}%
\@y{\@s{40.0}%
 \ensuremath{actorInboxes[fingerTables[self][fingerStart(self,\, i,\, bm)]]
 \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{40.0}%
 \ensuremath{Append(actorInboxes[fingerTables[self][fingerStart(self,\, i,\,
 bm)]],\, currentMessage)};
}%
\@xx{}%
\@x{}%
...
\@x{}%
\@y{\@s{40.0}%
 if (\ensuremath{kind \.{=} \@w{Stabilize}}) \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{47.5}%
 \ensuremath{actorInboxes[fingerTables[self][fingerStart(self,\,
 currentMessage[2],\, bm)]] \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{47.5}%
 \ensuremath{Append(actorInboxes[fingerTables[self][fingerStart(self,\,
 currentMessage[2],\, bm)]],\, {\langle}\mbox{``}GetPredecessor\mbox{''},\,
 self{\rangle})};
}%
\@xx{}%
\@x{}%
...
\@x{}%
\@y{\@s{50.0}%
 if (\ensuremath{kind \.{=}} ``\ensuremath{GetPredecessor}'') \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{60.0}%
 \ensuremath{actorInboxes[currentMessage[2]] \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{60.0}%
 \ensuremath{Append(actorInboxes[currentMessage[2]],\,
 {\langle}\mbox{``}GotPredecessor\mbox{''},\, predecessors[self]{\rangle})};
}%
\@xx{}%
\@x{}%
\@y{\@s{50.0}%
...
\@x{}%
\@y{\@s{60.0}%
 if (\ensuremath{kind \.{=}} ``\ensuremath{GotPredecessor}'') \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{67.5}%
 if (\ensuremath{between00(currentMessage[2],\,
 fingerTables[self][fingerStart(self,\, 1,\, bm)],\, self)})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{77.5}%
...
\@x{}%
\@y{\@s{67.5}%
 \ensuremath{actorInboxes[fingerTables[self][fingerStart(self,\, 1,\, bm)]]
 \.{:=}
}}%
\@xx{}%
\@x{}%
\@y{\@s{67.5}%
 \ensuremath{Append(actorInboxes[fingerTables[self][fingerStart(self,\, 1,\,
 bm)]],\, {\langle}\mbox{``}Notify\mbox{''},\, self{\rangle})};
}%
\@xx{}%
\@x{}%
\@y{\@s{60.0}%
...
\@x{}%
\@y{\@s{70.0}%
 if (\ensuremath{kind \.{=}} ``Notify'') \ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{80.0}%
 if (\ensuremath{predecessors[self] \.{\neq} NULL})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{87.5}%
 if (\ensuremath{between00(currentMessage[2],\, self,\,
 predecessors[self])})\ensuremath{\{
}}%
\@xx{}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{predecessors[self] \.{:=} currentMessage[2]};
}%
\@xx{}%
\@x{}%
\@y{\@s{87.5}%
...
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{ReturnDefaults\.{:}\.{+}
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{currentMessage \.{:=} {\langle}\@w{?},\, NULL,\, NULL{\rangle}};
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{1ca98b0a}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{1c215811}'')
}%
\@xx{}%
...
\@x{\@s{167.75} \.{\land} {\IF} joined [ self ] \.{\neq} {\TRUE}}%
 \@x{\@s{191.02} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{WhileWaitForMessagesBeforeJoin} ]}%
 \@x{\@s{191.02} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{Stabilize} ]}%
 \@x{\@s{167.75} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\, triggered
 ,\,}%
\@x{\@s{241.34} fingerTables ,\, predecessors ,\,}%
\@x{\@s{241.34} currentMessage ,\, kind ,\, id ,\, i ,\,}%
\@x{\@s{241.34} joined {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ WhileWaitForMessagesBeforeJoin ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{WhileWaitForMessagesBeforeJoin}}%
 \@x{\@s{193.07} \.{\land} {\IF} actorInboxes [ self ] \.{\neq} {\langle}
 {\rangle}}%
 \@x{\@s{216.34} \.{\THEN} \.{\land} currentMessage \.{'} \.{=} [
 currentMessage {\EXCEPT} {\bang} [ self ] \.{=} Head ( actorInboxes [ self ]
 ) ]}%
 \@x{\@s{247.65} \.{\land} kind \.{'} \.{=} [ kind {\EXCEPT} {\bang} [ self ]
 \.{=} Head ( currentMessage \.{'} [ self ] ) ]}%
 \@x{\@s{247.65} \.{\land} actorInboxes \.{'} \.{=} [ actorInboxes {\EXCEPT}
 {\bang} [ self ] \.{=} Tail ( actorInboxes [ self ] ) ]}%
\@x{\@s{216.34} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{247.65} \.{\land} {\UNCHANGED} {\langle} actorInboxes ,\,}%
\@x{\@s{321.24} currentMessage ,\,}%
\@x{\@s{321.24} kind {\rangle}}%
 \@x{\@s{193.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ProcessMessageBeforeJoin} ]}%
\@x{\@s{193.07} \.{\land} {\UNCHANGED} {\langle} triggered ,\,}%
\@x{\@s{266.66} fingerTables ,\,}%
\@x{\@s{266.66} predecessors ,\, id ,\, i ,\,}%
\@x{\@s{266.66} joined {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{78.83} \.{\lor} WhileWaitForMessagesBeforeJoin ( self )}%
...
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( Next )}%
 ...
 WhileWaitForMessagesBeforeJoin ( self ) ) \.{\land} {\SF}_{ vars} (
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun May 01 22:38:33
