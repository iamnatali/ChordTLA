...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "f31d2a3d" /\ chksum(tla) = "2622789d")
...
Spec == /\ Init /\ [][Next]_vars
        ...
        /\ \A self \in {0, 1, 3} : /\ WF_vars(actor(self))
                                   /\ SF_vars(WaitForMessages(self)) /\ SF_vars(ProcessMessage(self))
...
\* Last modified Mon Jan 31 02:54:55 YEKT 2022 by pervu
