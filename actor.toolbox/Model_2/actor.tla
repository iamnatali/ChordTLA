...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "1ecc79c" /\ chksum(tla) = "52de0597")
...
actor(self) == Join(self) \/ WaitForMessages(self) \/ WhileAfterJoin(self)
                  \/ T1(self) \/ FindFirstSuitableI(self) \/ MainLoop(self)
...
\* Last modified Thu Apr 07 01:37:53 YEKT 2022 by pervu
